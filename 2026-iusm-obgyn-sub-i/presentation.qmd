...
::: aside
Hani M. Al Salam, Radiopaedia.org, rID: 12507
:::
...
::: {.columns}
::: {.column}
![](images/ufe-proc-overview.jpg){.lightbox}
:::
::: {.column}
Vascular access: 
...
{{< video https://youtu.be/SwkCXyTV8b0?si=MjPXCaai6sbH3UHg&t=17 start="17" width="100%" height="85%" >}}

## Procedure

::: {.columns}
::: {.column}
![](images/uae-histo.jpeg){.lightbox}
:::
::: {.column}
Vascular access: 
...
[](images/evolution.jpg){width="400"}

## Quality of Life and Symptom Control {.scrollable}
...
[](images/srma-reintervention.png){.scrollable}
