...
## Welcome to the IR Chalk Talk [^1]

[^1]: Adapted from Patel et al., SIR Consensus Guidelines 2019

::: {.callout-tip icon=false}

"We love to stop bleeding – but we'd rather not start it."
:::

## Why does IR care about anticoagulation?
...
Today: How to evaluate, when to hold, how to correct, and when to bridge.

Let's draw the roadmap.

## Pre-Procedure Coagulation Labs: The Basics [^1]
...
::: aside
[^1]: Based on SIR 2019 Consensus Guidelines
:::

## Common Anticoagulants: Warfarin [^3]
...
::: aside
[^3]: Based on ACCP and SIR guidance
:::
...
- BRIDGE trial [^4] showed increased bleeding without significant reduction in thrombotic events for AFib patients with moderate stroke risk (CHADS2‑VASc ≤4)

::: aside
[^4]: BRIDGE Trial, NEJM 2015
:::
